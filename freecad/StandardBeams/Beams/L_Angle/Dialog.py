...
class Dialog(QDialog):
    ...
    def load_current_standard(self):
        folder, sizes_csv = l_angle_standards[self.current_standard]
        self.sizes_list, self.sizes_dict = load_l_angle_sizes(folder, sizes_csv)
    ...
    def setup_ui(self):
        ...
        folder, _ = l_angle_standards[self.current_standard]
