...
def createBeam(size_data, length, standard_name="RHS (EN 10210-2)"):
    ...
    folder, sizes_csv = rectangular_tube_standards[standard_name]
    _, rectangular_tube_sizes = load_rectangular_tube_sizes(folder, sizes_csv)
