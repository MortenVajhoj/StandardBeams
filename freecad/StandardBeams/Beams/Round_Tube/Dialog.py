...
class Dialog(QDialog):
    ...
    def load_current_standard(self):
        folder, sizes_csv = round_tube_standards[self.current_standard]
        self.sizes_list, self.sizes_dict = load_round_tube_sizes(folder, sizes_csv)
    ...
    def setup_ui(self):
        ...
        folder, _ = round_tube_standards[self.current_standard]
