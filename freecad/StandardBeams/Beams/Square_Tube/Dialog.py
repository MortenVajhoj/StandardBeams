...
class Dialog(QDialog):
    ...
    def load_current_standard(self):
        folder, sizes_csv = square_tube_standards[self.current_standard]
        self.sizes_list, self.sizes_dict = load_square_tube_sizes(folder, sizes_csv)
    ...
    def setup_ui(self):
        ...
        folder, _ = square_tube_standards[self.current_standard]
