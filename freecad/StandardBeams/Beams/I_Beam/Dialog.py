...
class Dialog(QDialog):
    ...
    def load_current_standard(self):
        folder, sizes_csv = I_beam_standards[self.current_standard]
        self.sizes_list, self.sizes_dict = load_i_beam_sizes(folder, sizes_csv)
    ...
    def setup_ui(self):
        ...
        folder, _ = I_beam_standards[self.current_standard]
