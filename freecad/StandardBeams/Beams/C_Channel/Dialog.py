...
class Dialog(QDialog):
    ...
    def load_current_standard(self):
        folder, sizes_csv = C_channel_standards[self.current_standard]
        self.sizes_list, self.sizes_dict = load_c_channel_sizes(folder, sizes_csv)
    ...
    def setup_ui(self):
        ...
        folder, _ = C_channel_standards[self.current_standard]
