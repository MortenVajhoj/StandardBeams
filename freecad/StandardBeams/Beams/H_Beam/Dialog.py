...
class Dialog(QDialog):
    ...
    def load_current_standard(self):
        folder, sizes_csv = H_beam_standards[self.current_standard]
        self.sizes_list, self.sizes_dict = load_h_beam_sizes(folder, sizes_csv)
    ...
    def setup_ui(self):
        ...
        folder, _ = H_beam_standards[self.current_standard]
